ZrehenMeasure4All <- function(Data, Projection, width, height, isToroid=FALSE, isGrid=TRUE, plotGabriel=FALSE){
  ...
  TileBM =function (BestMatches, Lines, Columns) 
  {
    ...
    if (ncol(as.matrix(BestMatches)) == 3) {
      BestMatches = cbind(as.numeric(BestMatches[, 1]), as.numeric(BestMatches[, 
                                                                               2]), as.numeric(BestMatches[, 3]))
      TiledBestMatches <- rbind(BestMatches, cbind(BestMatches[, 
                                                               1], (BestMatches[, 2] + Lines), BestMatches[, 3]), 
                                cbind(BestMatches[, 1:2], (BestMatches[, 3] + Columns)), 
                                cbind(BestMatches[, 1], (BestMatches[, 2] + Lines), 
                                      (BestMatches[, 3] + Columns)))
    }
    else {
      if (ncol(as.matrix(BestMatches)) == 2) {
        BestMatches = cbind(1:length(BestMatches[, 1]), BestMatches)
        BestMatches = cbind(as.numeric(BestMatches[, 1]), 
                            as.numeric(BestMatches[, 2]), as.numeric(BestMatches[, 
                                                                                 3]))
        TiledBestMatches <- rbind(BestMatches, cbind(BestMatches[, 
                                                                 1], (BestMatches[, 2] + Lines), BestMatches[, 
                                                                                                             3]), cbind(BestMatches[, 1:2], (BestMatches[, 
                                                                                                                                                         3] + Columns)), cbind(BestMatches[, 1], (BestMatches[, 
                                                                                                                                                                                                              2] + Lines), (BestMatches[, 3] + Columns)))
      }
      else {
  ...
  if(!isGrid){
    if(isToroid)#dann mit bestmatches als voraussetzung
      tmpPoints <- DatabionicSwarm::ProjectedPoints2Grid(Projection,height,width)
